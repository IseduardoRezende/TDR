...
namespace TDR.Migrations
{
    ...
    [Migration("20240226223654_AdicaoDeTabelasEAtualizacoesEmCampos")]
    partial class AdicaoDeTabelasEAtualizacoesEmCampos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TDRData.Models.Funcionalidade", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TDR.Models.Usuario", b =>
                {
                    b.HasOne("TDRData.Models.Funcionalidade", "Funcionalidade")
                        .WithMany("Usuarios")
                        .HasForeignKey("FuncionalidadeFk")
